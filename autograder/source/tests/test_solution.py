...
class TestSolution(unittest.TestCase):
    ...
    def test_enumerate_possible_worlds_1(self):
        ...
        self.assertEqual(student_possible_worlds, {(frozenset({tuple()}), ())}, msg = "Expected possible worlds from initial position before recording percepts to be {frozenset(), ()}, as shown in README.")
